...
if __name__ == '__main__':
	...
	for i, hparams in enumerate(grid):
		...
		clmbr_model_path = f"{args.model_path}/{args.clmbr_type}/models/{args.encoder}_sz_{hparams["size"]}_do_{hparams["dropout"]}_lr_{hparams["lr"]}_l2_{hparams["l2"]}"
		...
		for task in tasks:
			...
			for fold in ['train', 'val', 'test']:
				...
				task_path = f"{args.labelled_fpath}/{args.clmbr_type}/{args.encoder}_sz_{hparams["size"]}_do_{hparams["dropout"]}_lr_{hparams["lr"]}_l2_{hparams["l2"]}/{task}"
